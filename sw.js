...
self.addEventListener('fetch',e=>{
  ...
  // {cache:'no-store'} skips the browser HTTP cache — GitHub Pages sends
  // Cache-Control: max-age=600, which otherwise made "network-first" serve a
  // copy up to 10 minutes stale and hid fresh deploys.
  e.respondWith(
